...
objects = parser.o scanner.o symbol_table.o tree.o klammer.o optimierung1.o multiple.o #error.o debug.o symboltable.o syntaxtree.o optimize.o generate.o process.o main.o
CC	= gcc
LEX	= flex
YACC	= bison
