...
objects = parser.o scanner.o symboltable.o tree.o #error.o debug.o syntaxtree.o optimize.o generate.o process.o main.o
CC	= gcc
LEX	= flex
YACC	= bison
...
parser.o:	parser.h symboltable.h tree.h
